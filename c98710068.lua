...
local m=98710068
local cm=_G["c"..m]
function c98710068.initial_effect(c)
   --Activate
...
function cm.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return tc:IsControler(tp) and tc:IsPosition(POS_FACEUP) and tc:IsSetCard(0x70c1)
end
function cm.cfilter(c)
	return c:IsSetCard(0x70c1) and c:IsAbleToGraveAsCost()
end
