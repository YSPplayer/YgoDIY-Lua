--奥利哈刚 天神荡 （ZCG）
function c98710592.initial_effect(c)
	  --Activate
	...
	e1:SetTarget(c98710592.target)
	e1:SetOperation(c98710592.activate)
	c:RegisterEffect(e1)
end
function c98710592.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c98710592.activate(e,tp,eg,ep,ev,re,r,rp)
