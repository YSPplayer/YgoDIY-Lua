...
local m=98710677
local cm=_G["c"..m]
function c98710677.initial_effect(c)
	   --search
...
function cm.filter3(c,e,tp)
	return c:IsCode(98710653) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function cm.filter(c)
	return c:IsCode(98710653) and c:IsAbleToHand()
end
