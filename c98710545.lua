--奥利哈刚 蓝蛇男 (ZCG)
function c98710545.initial_effect(c)
	   --fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCodeRep(c,98710427,2,true,true)
	--to grave
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(98710545,0))
	e3:SetCategory(CATEGORY_RELEASE)
	e3:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e3:SetCode(EVENT_ATTACK_ANNOUNCE)
	e3:SetCountLimit(1)
	e3:SetTarget(c98710545.destg)
	e3:SetOperation(c98710545.desop)
	c:RegisterEffect(e3)
end
function c98710545.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c98710545.desop(e,tp,eg,ep,ev,re,r,rp)
