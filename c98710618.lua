--太阳神之钢铁进化龙 （ZCG）
function c98710618.initial_effect(c)
	 --damage
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(98710618,0))
	e1:SetCategory(CATEGORY_DAMAGE)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1) 
	e1:SetCost(c98710618.cost)
	e1:SetTarget(c98710618.target)
	e1:SetOperation(c98710618.operation)
	c:RegisterEffect(e1)
	...
	e52:SetOperation(c98710618.disop2)
	...
	e53:SetTarget(c98710618.distg2)
	...
	e54:SetTarget(c98710618.distg2)
	c:RegisterEffect(e54)
end
-------------------------------------------------------------------------
function c98710618.disop2(e,tp,eg,ep,ev,re,r,rp)
...
function c98710618.distg2(e,c)
	return c:GetCardTargetCount()>0 and c:IsType(TYPE_TRAP)
		and c:GetCardTarget():IsContains(e:GetHandler())
end
-------------------------------------------------------------------------
function c98710618.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c98710618.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetTargetPlayer(1-tp)
	Duel.SetTargetParam(e:GetHandler():GetLevel()*200)
	Duel.SetOperationInfo(0,CATEGORY_DAMAGE,nil,0,1-tp,e:GetHandler():GetLevel()*200)
end
function c98710618.operation(e,tp,eg,ep,ev,re,r,rp)
