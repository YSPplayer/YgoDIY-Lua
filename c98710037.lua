...
local m=98710037
local cm=_G["c"..m]
function c98710037.initial_effect(c)
	c:EnableReviveLimit()
...
function cm.coop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,98710038,0x70c1,0x4011,tc:GetAttack(),tc:GetDefense(),
	...
	if g:GetCount()>0 then
		...
		local token=Duel.CreateToken(tp,98710038)
