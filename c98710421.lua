--奥利哈刚 元素召唤者 （ZCG）
function c98710421.initial_effect(c)
--SpecialSummon
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringid(98710421,0))
	e4:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCountLimit(1)
	e4:SetTarget(c98710421.target)
	e4:SetOperation(c98710421.activate)
	c:RegisterEffect(e4)
end
function c98710421.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c98710421.activate(e,tp,eg,ep,ev,re,r,rp)
