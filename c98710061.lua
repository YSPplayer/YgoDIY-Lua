...
local m=98710061
local cm=_G["c"..m]
function c98710061.initial_effect(c)
	  --disable zone
...
function cm.condition(e,tp,eg,ep,ev,re,r,rp)
	return not Duel.IsExistingMatchingCard(cm.defilter,tp,0,LOCATION_MZONE,1,nil)
end
function cm.condition2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(cm.defilter,tp,0,LOCATION_MZONE,1,nil)
end
