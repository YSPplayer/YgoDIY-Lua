--奥西里斯之炎帝 （ZCG）
function c98710366.initial_effect(c)
	  --summon
	...
	e2:SetTarget(c98710366.retg)
	e2:SetOperation(c98710366.reop)
	c:RegisterEffect(e2)
--disable effect
	...
	e12:SetOperation(c98710366.disop9)
 ...
 --immune
	...
	e13:SetValue(c98710366.efilter9)
	c:RegisterEffect(e13)
end
function c98710366.disop9(e,tp,eg,ep,ev,re,r,rp)
...
function c98710366.efilter9(e,te)
	return te:GetHandler():IsSetCard(0x70c1)
end
function c98710366.retg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c98710366.reop(e,tp,eg,ep,ev,re,r,rp)
