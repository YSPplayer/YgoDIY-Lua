--太阳神之守护女 （ZCG）
function c98710617.initial_effect(c)
  --flip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(98710617,0))
	e1:SetCategory(CATEGORY_CONTROL)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_FLIP)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_CANNOT_DISABLE)
	e1:SetTarget(c98710617.target)
	e1:SetOperation(c98710617.operation)
	c:RegisterEffect(e1)
	...
	e52:SetOperation(c98710617.disop2)
	...
	e53:SetTarget(c98710617.distg2)
	...
	e54:SetTarget(c98710617.distg2)
	c:RegisterEffect(e54)   
end
-------------------------------------------------------------------------
function c98710617.disop2(e,tp,eg,ep,ev,re,r,rp)
...
function c98710617.distg2(e,c)
	return c:GetCardTargetCount()>0 and c:IsType(TYPE_TRAP)
		and c:GetCardTarget():IsContains(e:GetHandler())
end
-------------------------------------------------------------------------
function c98710617.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c98710617.operation(e,tp,eg,ep,ev,re,r,rp)
