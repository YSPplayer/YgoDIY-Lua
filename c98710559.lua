--奥利哈刚 铁甲战士 （ZCG）
function c98710559.initial_effect(c)
 local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(98710559,0))
	e1:SetCategory(CATEGORY_ATKCHANGE)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e1:SetCode(EVENT_BATTLE_DESTROYING)
	e1:SetLabel(500)
	e1:SetCondition(c98710559.atkcon)
	e1:SetOperation(c98710559.operation)
	c:RegisterEffect(e1)
 --spsummon
	local e7=Effect.CreateEffect(c)
	e7:SetDescription(aux.Stringid(98710559,1))
	...
	e7:SetCondition(c98710559.spcon)
	e7:SetTarget(c98710559.sptg)
	e7:SetOperation(c98710559.spop)
	c:RegisterEffect(e7)
	--negate
	...
	e2:SetOperation(c98710559.disop)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	...
	e4:SetTarget(c98710559.distg)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	e5:SetCode(EFFECT_DISABLE_EFFECT)
	c:RegisterEffect(e5)
end
function c98710559.disop(e,tp,eg,ep,ev,re,r,rp)
...
function c98710559.distg(e,c)
	return c:GetFlagEffect(98710392)~=0
end
function c98710559.spcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:IsPreviousLocation(LOCATION_ONFIELD)
end
function c98710559.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c98710559.spop(e,tp,eg,ep,ev,re,r,rp)
...
function c98710559.operation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c98710559.atkcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
