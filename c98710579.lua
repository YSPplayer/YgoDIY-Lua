--奥利哈刚的诅咒 （ZCG）
function c98710579.initial_effect(c)
	...
	e0:SetCondition(c98710579.mocon)
	e0:SetOperation(c98710579.moop)
	c:RegisterEffect(e0)
--
	...
	e1:SetCondition(c98710579.mocon2)
	e1:SetOperation(c98710579.moop2)
	c:RegisterEffect(e1)
end
function c98710579.mocon(e,tp,eg,ep,ev,re,r,rp)
	return tp==Duel.GetTurnPlayer()
end
function c98710579.moop(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c98710579.mocon2(e,tp,eg,ep,ev,re,r,rp)
	return 1-tp==Duel.GetTurnPlayer()
end
function c98710579.moop2(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if Duel.GetLocationCount(tp,LOCATION_SZONE,0)>0 then
	Duel.MoveToField(c,tp,tp,LOCATION_SZONE,POS_FACEUP,true)
	Duel.BreakEffect()
