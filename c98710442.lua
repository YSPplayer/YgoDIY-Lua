--奥利哈刚 托利托斯 （ZCG）
function c98710442.initial_effect(c)
			--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(98710442,0))
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_HAND)
	e1:SetCondition(c98710442.condition)
	e1:SetOperation(c98710442.moop)
	c:RegisterEffect(e1)
		--Activate
	...
	e2:SetCondition(c98710442.condition)
	e2:SetTarget(c98710442.motg)
	e2:SetOperation(c98710442.moop2)
	c:RegisterEffect(e2)
	--selfdes
	...
	e4:SetCondition(c98710442.sdcon2)
	e4:SetOperation(c98710442.sdop)
	c:RegisterEffect(e4)
 ...
 --cannot trigger
	...
	e8:SetTarget(c98710442.distg)
	c:RegisterEffect(e8)
end
function c98710442.distg(e,c)
	return c:IsType(TYPE_SPELL)
end
function c98710442.efilter(e,re)
	return e:GetOwnerPlayer()~=re:GetOwnerPlayer() and re:IsActiveType(TYPE_SPELL+TYPE_TRAP)
end
function c98710442.sdcon2(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(98710442)==0
end
function c98710442.sdop(e,tp,eg,ep,ev,re,r,rp) 
	e:GetHandler():CopyEffect(98710441,RESET_EVENT+0x1fe0000)
	e:GetHandler():RegisterFlagEffect(98710442,RESET_EVENT+0x1fe0000,0,1)
end
function c98710442.cfilter(c)
	return c:IsFaceup() and c:IsCode(98710441)
end
function c98710442.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c98710442.cfilter,tp,LOCATION_ONFIELD,0,1,nil)
end
function c98710442.motg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c98710442.moop(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	Duel.MoveToField(c,tp,tp,LOCATION_FZONE,POS_FACEUP,true)
end
function c98710442.moop2(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
