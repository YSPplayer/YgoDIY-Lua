--奥利哈刚 末日之音 （ZCG）
function c98710517.initial_effect(c)
...
--draw
	...
	e3:SetCondition(c98710517.condition2)
	e3:SetOperation(c98710517.operation2)
	c:RegisterEffect(e3)
 --win
	...
	e4:SetOperation(c98710517.winop)
	c:RegisterEffect(e4)
end
function c98710517.winop(e,tp,eg,ep,ev,re,r,rp)
...
function c98710517.condition2(e,tp,eg,ep,ev,re,r,rp)
	return 1-tp==Duel.GetTurnPlayer()
end
function c98710517.operation2(e,tp,eg,ep,ev,re,r,rp)
