--奥利哈刚 末日之音 （ZCG）
function c98710582.initial_effect(c)
...
--draw
	...
	e3:SetCondition(c98710582.condition2)
	e3:SetOperation(c98710582.operation2)
	c:RegisterEffect(e3)
 --win
	...
	e4:SetOperation(c98710582.winop)
	c:RegisterEffect(e4)
end
function c98710582.winop(e,tp,eg,ep,ev,re,r,rp)
...
function c98710582.condition2(e,tp,eg,ep,ev,re,r,rp)
	return 1-tp==Duel.GetTurnPlayer()
end
function c98710582.operation2(e,tp,eg,ep,ev,re,r,rp)
